...
<body>		
    ...
    <div id="wrapper" class="container">
		...
		<section  >
			<li>
				<img src="imagini/main.png" alt="" width=1500px />
			</li>		
		</section>
	</div>
...
<section class="main-content">
	<h4 class="title">
		<span class="pull-left"><span class="text"><span class="line">cele mai cumparate <strong>Produsele</strong></span></span></span>
	</h4>
	<div class="row">	
		<?php
		$product_array = $db_handle->runQuery("SELECT * FROM produsetapiterie ORDER BY cumparari DESC LIMIT 4");
...
<section class="main-content">
	<h4 class="title">
		<span class="pull-left"><span class="text"><span class="line">Produse <strong>recomandate</strong></span></span></span>
	</h4>
	<div class="row">	
		<?php
		$product_array = $db_handle->runQuery("SELECT * FROM produsetapiterie ORDER BY rating DESC LIMIT 4");
		if (!empty($product_array)) { 
			foreach($product_array as $key=>$value){
		?>
		<li class="span3">
...
<section class="main-content">
	<h4 class="title">
		<span class="pull-left"><span class="text"><span class="line">Produse <strong>recente</strong></span></span></span>
	</h4>
	<div class="row">	
		<?php
		$product_array = $db_handle->runQuery("SELECT * FROM produsetapiterie ORDER BY data DESC LIMIT 4");
		if (!empty($product_array)) { 
			foreach($product_array as $key=>$value){
		?>
		<li class="span3">
